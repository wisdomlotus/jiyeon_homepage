...
/* ════════════════════════════════
   초기화 — data.js의 startApp()이 로드 완료 후 호출
════════════════════════════════ */
function appInit() {
  updateFab();
...
function refreshCurrentPage() {
  if (currentPage === 'workout') { renderWorkoutCalendar(); renderWorkoutList(); }
  if (currentPage === 'challenge') { renderChallengeSection(); }
  if (currentPage === 'som') { renderSomCalendar(); renderSomGallery(); renderSomComments(); }
  if (currentPage === 'diary') { renderDiary(); }
}
